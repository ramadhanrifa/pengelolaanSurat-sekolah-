...
@section('content')
    <h1>Edit Data TU</h1>
    <h5><a href="{{route('user.tu.dashboard.page')}}" class="text-primary-emphasis">Dashboard</a> / <a href="{{ route('user.tu.index')}}" class="text-primary-emphasis">Data Staff</a> / <a href="#" class="text-primary">Edit Data Staff</a></h5>
