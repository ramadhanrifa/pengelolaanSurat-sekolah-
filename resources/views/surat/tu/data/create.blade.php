...
@section('content')
    ...
    <h5><a href="{{route('user.tu.dashboard.page')}}" class="text-primary-emphasis">Dashboard</a> / <a href="{{ route('surat.tu.data.index')}}" class="text-primary-emphasis">Data Surat</a> / <a href="#" class="text-primary">Tambah Surat</a></h5>
